...
export const cabins = [
...

  {
    ...
    description:
      "Enjoy a peaceful escape in cabin 009, perfect for small families or friends. This cabin features modern wooden interiors, a cozy living area, and a fully-equipped kitchen. The private deck offers beautiful forest views and a relaxing hot tub.",
  },
  {
    name: "010",
    maxCapacity: 5,
    regularPrice: 420,
    discount: 40,
    image: imageUrl + "cabin-010.png",
    description:
      "Cabin 010 is designed for comfort and style, accommodating up to 5 guests. With spacious bedrooms, a fireplace, and a gourmet kitchen, this cabin is ideal for families or groups. Enjoy the private outdoor area with a hot tub and seating.",
  },
];
